...
function Sidebar() {
  return (
    <aside
      className="fixed top-0 left-0 flex flex-col bg-[#EEF0FF] shadow-md border-r border-indigo-100"
      style={{width: SIDEBAR_WIDTH, minWidth: SIDEBAR_WIDTH, maxWidth: SIDEBAR_WIDTH, height: '100vh', zIndex: 20}}
    >
      ...
      <div className="flex items-center justify-between border-b border-indigo-100"
        ...
        {/* Hamburger */}
        <button className="p-2 rounded hover:bg-indigo-100 focus:outline-none">
